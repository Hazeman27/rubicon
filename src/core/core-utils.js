...
/**
 * Generates regular expression that matches path strings with specified file extensions.
 *
 * @param {string[]} extensions Array of extensions to match. Without preceding dot. For example, `js, ts` are valid arguments while `.js, .ts` are not.
...
/**
 * Logs error messages generated based on expected and received file types using specified logger function.
 *
 * @param {string} path File path that caused error.
 * @param {FilePathRegExp} regex Regular expression used to match file path that was generated by @see generateFilePathRegExp function.
